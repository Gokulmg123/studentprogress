        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-4">
            <div className="bg-white rounded-2xl shadow-2xl h-full flex flex-col items-center justify-center p-8">
              <div className="w-24 h-24 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-8">
                <svg 
              ...
              <div className="mt-8 w-full space-y-4">
                ...
                <a href="/login/adminlogin">
                  <button className="w-full px-6 py-3 bg-white text-purple-600 font-medium rounded-lg border-2 border-purple-600 hover:bg-purple-50 transition-all duration-200">
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="mb-8 pb-6 border-b border-gray-200">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h1 className="text-2xl font-bold text-gray-800">Admin Registration Form</h1>
